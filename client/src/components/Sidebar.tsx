    ...
    return (
        <div className={`component flex flex-col text-xs text-gray-400 absolute z-20 md:static md:translate-x-0 h-dvh transition-all ${isOpen ? "translate-x-0" : " -translate-x-full"}`}>
            ...
            <div className="flex flex-col gap-2 py-2 mini-component h-full">
                <button 
                    onClick={() => { setPage("Dashboard"); closeSidebar()}} 
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <button onClick={() => { setPage("Reports"); closeSidebar()}} 
                        className={`flex items-center gap-2 py-2 px-5 dark:hover:bg-[#182037] hover:bg-[#EEF2FF] 
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <button onClick={() => { setPage("Users"); closeSidebar()}} 
                    className={`flex items-center gap-2 py-2 px-5 dark:hover:bg-[#182037] hover:bg-[#EEF2FF] 
